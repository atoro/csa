  ...
  <table width="287" border="1"  cellpadding="0">
    <tr>
      <td height="351"><table width="283" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="283" height="49" align="center" bgcolor="#205588" class="titulos2" style="color:white;">MENU PRINCIPAL</td>
        </tr>
        
        <tr>
          <td height="5" align="left" bgcolor="#205588"></td>
        </tr>
        <tr>
          <td height="30" align="center" bgcolor="#FFFFFF"  class="logo" style="color:white;"><span class="texto"><a href="slide.php" class="texto">Slide</a></span></td>
        </tr>
        <tr>
          <td height="30" align="center" bgcolor="#FFFFFF"  class="texto" ><span class="logo" style="color:white;"><a href="inicio.php" class="texto">Inicio</a></span></td>
        </tr>
        <tr>
          <td height="30" align="center" bgcolor="#FFFFFF"  class="logo" ><a href="nosotros.php" class="texto">Nosotros</a></td>
        </tr>
        <tr>
          <td height="30" align="center" bgcolor="#FFFFFF"  class="logo" ><a href="servicios.php" class="texto">Servicios</a></td>
        </tr>
        <tr>
          <td height="30" align="center" bgcolor="#FFFFFF"  class="logo" ><a href="servicios_pie.php" class="texto">Servicios Pie</a></td>
        </tr>
        <tr>
          <td height="30" align="center" bgcolor="#FFFFFF"  class="logo" ><a href="destacados.php" class="texto">Servicios Destacados</a></td>
        </tr>
        <tr>
          <td height="30" align="center" bgcolor="#FFFFFF"  class="logo" ><a href="noticias.php" class="texto">Noticias</a></td>
        </tr>
        <tr>
          <td height="30" align="center" bgcolor="#FFFFFF"  class="logo" ><a href="pie.php" class="texto">Contacto Pie</a></td>
        </tr>
        <tr>
